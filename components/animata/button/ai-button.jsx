...
// Convert TypeScript type to JSX object
const options = {
  key: "star",
  name: "Star",
  particles: {
...
export default function AiButton({
  children = "Generate thumbnails", // Default text
  ...
  const modifiedOptions = useMemo(() => {
    ...
    newOptions.autoPlay = isHovering;
    return newOptions;
  }, [isHovering]);

  return (
    <button
      className={`group relative my-8 rounded-full bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-40% to-purple-500/30 p-1 text-white transition-transform hover:scale-110 active:scale-105 ${className} ${
