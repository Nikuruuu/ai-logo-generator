export default {
  DESIGN_IDEA_PROMPT:
    "Based on Logo of type {logoType} Generate a text prompt to create Logo for Logo title/Brand name : {logoTitle} with description: {logoDesc} and referring to prompt: {logoPrompt}. Give me 4/5 Suggestion of logo idea (each idea with maximum 4-5 words), Result in JSON format",
  LOGO_PROMPT:
